...
| D29 | Real Spotify via **spotipy**; scan tracks via **Search**; avoid restricted endpoints | spotipy handles tokens/retries; post-2024-11-27 `preview_url` is null in SimpleTrack/multi-get, full Track objects from Search still carry it; recommendations/related-artists/audio-features/featured-playlists restricted for new apps |
